...
\title{CE 401/5501: Applied Machine Learning\\ \large Topic 5: Introduction to Neural Networks}
...
\section{Neuron Cell and Perception}
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{figs/Topic05fig01.png}
...
\begin{subfigure}[b]{0.5\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{figs/Topic05fig02.png}
    \caption{}
    \label{t05fig02}
\end{subfigure}
\begin{subfigure}[b]{0.5\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{figs/Topic05fig03.png}
    \caption{}
    \label{t05fig03}
\end{subfigure}
...
While logistic regression yields a convex optimization problem, the optimization for a perceptron is not necessarily convex.
...
%     \centering
%     \includegraphics[width=1\textwidth]{figs/Topic05fig04a.png}
%     \caption{}
%     \label{t05fig04a}
% \end{subfigure}
% \begin{subfigure}[b]{0.45\textwidth}
%     \centering
%     \includegraphics[width=1\textwidth]{figs/Topic05fig04b.png}
%     \caption{}
%     \label{t05fig04b}
% \end{subfigure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{figs/Topic05fig05.png}
    \caption{Decision boundary for (a) separable data points and (b) non-separable data points. For non-separable data, a nonlinear decision boundary is necessary.}
    \label{t05fig05}
\end{figure}
