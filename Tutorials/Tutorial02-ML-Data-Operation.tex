...
# Mount Google Drive and set a working folder
from google.colab import drive
import os

drive.mount('/content/drive')

# Update this path to match your course folder
# (In Colab, Google Drive is typically mounted under /content/drive/MyDrive/)
folder_path = '/content/drive/MyDrive/Classroom/UMKC CE401 5501 Applied AI/Topic02'

# List files and (optionally) change the working directory
...
\subsection{Handling Structured Data}
...
# Load the Excel file created above (two sheets: Students and Matrix)
students_df = pd.read_excel('/content/drive/MyDrive/data.xlsx', sheet_name='Students')
matrix_df = pd.read_excel('/content/drive/MyDrive/data.xlsx', sheet_name='Matrix')
...
\begin{lstlisting}[numbers=none,language=Python, caption=Data Manipulation]
import datetime as dt

# Filter records (e.g., students with score >= 90)
high_score = students_df[students_df['Score'] >= 90]
display(high_score)

# Add a computed column using the current year (avoids hard-coding)
current_year = dt.date.today().year
students_df['Birth_Year'] = current_year - students_df['Age']
display(students_df)

# Simple grouped statistics (mean score by age)
score_by_age = students_df.groupby('Age')['Score'].agg(['mean', 'count'])
display(score_by_age)
\end{lstlisting}
