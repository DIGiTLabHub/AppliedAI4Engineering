...
\begin{itemize}
    ...
    \item This final assignment evaluates your understanding of AI foundations and machine learning methods in engineering. The problems are designed to progress from conceptual understanding to basic analytical formulation. Answer all parts of each problem.


    \item You may answer directly in the page (blank lines) or use your own paper.

    \item The submission will be digital online.

\end{itemize}
\end{ch-box}

\section{Problem 1: Engineering Logic \& Data Representation}
\textbf{Context:} We started by discussing the shift in engineering skills and data types.
