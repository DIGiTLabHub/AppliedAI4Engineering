...
\begin{frame}{What Makes These Architectures Generative?}
  ...
  \begin{itemize}
    \item CNNs become generative inside decoders, U-Nets, and image generators.
    \item Transformers become generative when they generate sequences token by token.
