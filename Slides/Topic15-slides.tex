...
\begin{frame}{Parameter Count Is Not the Whole Story}
  We should interpret parameter count carefully.
...
\begin{frame}{Training Is More Than Pretraining}
  We often hear that LLMs are trained by ``predicting the next token.'' That is true, but incomplete.
...
\begin{frame}{Why This Architecture Figure Matters}
  ...
  That distinction matters when we later study prompting, reasoning models, and coding assistants.
\end{frame}
